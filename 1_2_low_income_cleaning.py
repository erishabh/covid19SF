...
low_orig = pd.read_excel('SF_low_income.xlsx', sheet_name = 1, header = [0, 1, 2], index_col = 0)
...
low_clean.to_csv('SF_low_income_population_clean.csv', index = False, header = True)
